...
<body>
<div class="width100 hidden_yh" style="height: 573px;background: url('${ctx}/resource/user/images/login.png') no-repeat center">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <div class="right_yh bj_fff" style="width:408px;height: 438px;">
            <form action="${ctx}/login/utoLogin" method="post">
                ...
                <div class="center_yh hidden_yh" style="width: 336px;">
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        ...
                        <input type="text" placeholder="请输入用户名或手机号" data-validate="required:请填写账号"  name="userName" value="" style="border: 0;width: 292px;height: 42px; font-size: 16px;text-indent: 22px;">
                        <span class="icon icon-user margin-small">11</span>
                    </div>
                    <div class="width100 box-sizing hidden_yh" style="height: 44px;border:1px solid #c9c9c9;margin-bottom: 34px;">
                        <img src="${ctx}/resource/user/images/pass.jpg" alt="" class="left_yh" width="42" height="42">
                        <input type="password" placeholder="请输入密码" data-validate="required:请填写账号" name="passWord" value="" style="border: 0;width: 292px;height: 42px; font-size: 16px;text-indent: 22px;">
            ...
            <div class="tcenter width100" style="margin-top: 36px;">
                <a href="${ctx}/login/res"  style="color: grey">去注册</a>
            </div>
            <div class="tcenter width100" style="margin-top: 36px;">
